...
wait_time = 15*60.0 # s
delay_time = 0.0
#delay_time = 60*60.0 # s
#delay_time = 60*60.0 + 90*60.0 + 30*60.0 + 30*60.0 + 30*60.0 + 30*60.0 + 30*60.0 # s

time.sleep(delay_time)

snap_id_min_arr = array(range(snap_id_min_oa, snap_id_max_oa-snap_id_group+1, snap_id_group))
snap_id_max_arr = snap_id_min_arr + snap_id_group

for i in range(0, len(snap_id_min_arr)):
  snap_id_min = snap_id_min_arr[i]
  snap_id_max = snap_id_max_arr[i]

  for snap_id in range(snap_id_min, snap_id_max+1):
