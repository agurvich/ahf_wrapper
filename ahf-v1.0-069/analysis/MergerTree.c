...
#define MINCOMMON      50             // we only cross-correlate haloes if they at least share MINCOMMON particles
//#define ONLY_USE_PTYPE 4              // restrict analysis to particles of this type (1 = dark matter)
