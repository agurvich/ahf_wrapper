...
double calc_virial(double a)
{
  ...
  double sashapi, sashaz, sashaomega, sashax;
  ...
  sashaz = 1.0/a - 1.0;
  sashapi = 3.14159;
  sashaomega =  simu.omega0 * pow((1.0+sashaz), 3.0) / (  simu.omega0 * pow((1.0+sashaz), 3.0) + simu.lambda0);
  sashax = sashaomega -1.0;
  virial =  18.0 * sashapi* sashapi + 82.0*sashax - 39.0*sashax*sashax;
  return (virial);
}
/*=========================================================================
* collapse:
