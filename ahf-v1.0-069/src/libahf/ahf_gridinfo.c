                    ...
                    for(cur_node = icur_nquad->loc; 
                        ...
                        cur_node++, x++)
                      {
                       fprintf(gridinfofile,"p %lf %lf %lf 0.0 0.0 1.0 %lf %d\n",  
                               simu.boxsize*((double) x/(double)cur_grid->l1dim + cur_shift),
                               simu.boxsize*((double) y/(double)cur_grid->l1dim + cur_shift),
                               simu.boxsize*((double) z/(double)cur_grid->l1dim + cur_shift),
