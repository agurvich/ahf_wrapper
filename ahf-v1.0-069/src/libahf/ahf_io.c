...
#  endif
...
#else
   {
    ...
    fprintf(fout, "\t%16.8g",                            halos[i].pos_mbp.x * x_fac * 1000);
    fprintf(fout, "\t%16.8g",                            halos[i].pos_mbp.y * x_fac * 1000);
    fprintf(fout, "\t%16.8g",                            halos[i].pos_mbp.z * x_fac * 1000);   
    fprintf(fout, "\t%16.8g",                           halos[i].pos_com.x * x_fac * 1000);
    fprintf(fout, "\t%16.8g",                           halos[i].pos_com.y * x_fac * 1000);
    fprintf(fout, "\t%16.8g",                           halos[i].pos_com.z * x_fac * 1000);
#endif
#  ifdef GAS_PARTICLES
...
#  endif
   {
    ...
    COLUMN_INFO(fout, "mbp_x", column);
    COLUMN_INFO(fout, "mbp_y", column);
    COLUMN_INFO(fout, "mbp_z", column);
    COLUMN_INFO(fout, "com_x", column);
    COLUMN_INFO(fout, "com_y", column);
    COLUMN_INFO(fout, "com_z", column);
